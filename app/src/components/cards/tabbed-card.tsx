...
export interface TabbedCardProps {
  ...
  repoDependencies: Readonly<Signal<{
...
export const TabbedCard = component$<TabbedCardProps>(({ repoDetails, updateTopicsAction, repoDependencies }) => {
  return (
    <GenericCard>
      <div q:slot="header">
        <Tabs.Root selectedIndex={0} class="w-full">
          ...
          <Tabs.Panel class="text-gray-300 py-2 mt-4">Content 3</Tabs.Panel>
        </Tabs.Root>
      </div>
    </GenericCard>
  );
